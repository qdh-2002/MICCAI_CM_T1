...
from cm.MRI_datasets_dicom_kspace import load_data_from_dicom as load_data
...
import torch
print("Visible GPUs:", torch.cuda.device_count(), "– Using:", torch.cuda.current_device(), torch.cuda.get_device_name(torch.cuda.current_device()))
...
def main():
    ...
    model_and_diffusion_kwargs["sampling_channels"] = 3
