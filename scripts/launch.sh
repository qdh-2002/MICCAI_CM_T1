...
## MicroUS testing
mpiexec -n 1 python -m  scripts.inference_axial_all --training_mode consistency_distillation --sampler multistep --ts 0,67,150 --model_path ./save/train_7cases_1120/target_model080000.pt --attention_resolutions 32,16,8 --use_scale_shift_norm False --dropout 0.0 --image_size 256 --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --resblock_updown True --use_fp16 True --weight_schedule uniform --save_dir ./save/test_pathology_80k