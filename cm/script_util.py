...
def create_model_and_diffusion(
    ...
    model = create_model(
        ...
        sampling_channels=sampling_channels,
    )
...
def create_ema_and_scales_fn(
    ...
    def ema_and_scales_fn(step):
        ...
        # iCM:
            ...
            # K_prime = int(total_steps / (np.log2(end_scales / start_scales) + 1))
            # scales = np.minimum(start_scales * (2 ** (step / K_prime)), end_scales).astype(np.int32) + 1
            # scales = np.maximum(scales, 1) 
